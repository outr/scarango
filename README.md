...
```
libraryDependencies += "com.outr" %% "scarango-driver" % "3.11.12"
```

Or in Mill:

```
ivy"com.outr::scarango-driver:3.11.12"
```
...
//     name = "User 1",
//     age = 30,
//     _id = Id(value = "xHBCfA9apEB0RySx2mRb2u8tJ7946WQq", collection = "people")
//   ),
//   Person(
//     name = "Adam",
//     age = 21,
//     _id = Id(value = "oS5sW1lTzykogjKZCSLCm9kzAQd7gDUQ", collection = "people")
//   ),
//   Person(
//     name = "Bethany",
//     age = 19,
//     _id = Id(value = "JTDBSBc57Dat5b9ehrTXDQeaJk1F0RSq", collection = "people")
//   )
// )
```
