...
object APIGharialGraph {
  ...
  * </code></pre>
  */
  def delete(client: HttpClient, graph: String, dropCollections: Option[Boolean] = None): Future[Json] = client
  ...
  * </code></pre>
  */
  def get(client: HttpClient, graph: String): Future[GeneralGraphGetHttpExamplesRc200] = client
