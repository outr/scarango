...
object APIUserUserDatabaseDbnameCollection {
  ...
  * <!-- ---------------------------------------------------------------------- -->
  */
  def delete(client: HttpClient, user: String, dbname: String, collection: String): Future[Json] = client
  ...
  * <!-- ---------------------------------------------------------------------- -->
  */
  def put(client: HttpClient, body: UserHandlingGrantCollection, user: String, dbname: String, collection: String): Future[Json] = client
