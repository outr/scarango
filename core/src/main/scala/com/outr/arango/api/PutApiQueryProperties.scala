...
/**
  ...
  *
  * @param enabled If set to *true*, then queries will be tracked. If set to
  ...
  * @param trackBindVars If set to *true*, then the bind variables used in queries will be tracked 
  *        along with queries.
  * @param trackSlowQueries If set to *true*, then slow queries will be tracked
