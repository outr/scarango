...
/**
  ...
  * @param distributeShardsLike (The default is {@literal *}""{@literal *}): in an Enterprise Edition cluster, this attribute binds
  *        the specifics of sharding for the newly created collection to follow that of a
  *        specified existing collection.
  *        {@literal *}{@literal *}Note{@literal *}{@literal *}: Using this parameter has consequences for the prototype
  ...
  * @param doCompact whether or not the collection will be compacted (default is {@literal *}true{@literal *})
  ...
  *        time.
  *        This option is meaningful for the MMFiles storage engine only.
  * @param isSystem If {@literal *}true{@literal *}, create a  system collection. In this case {@literal *}collection-name{@literal *}
  *        should start with an underscore. End users should normally create non-system
  *        collections only. API implementors may be required to create system
  *        collections in very special occasions, but normally a regular collection will do.
  *        (The default is {@literal *}false{@literal *})
  * @param isVolatile If {@literal *}true{@literal *} then the collection data is kept in-memory only and not made persistent.
  ...
  * @param numberOfShards (The default is {@literal *}1{@literal *}): in a cluster, this value determines the
  *        number of shards to create for the collection. In a single
  *        server setup, this option is meaningless.
  * @param replicationFactor (The default is {@literal *}1{@literal *}): in a cluster, this attribute determines how many copies
  ...
  * @param shardKeys (The default is {@literal *}[ "_key" ]{@literal *}): in a cluster, this attribute determines
  *        which document attributes are used to determine the target shard for documents.
  *        Documents are sent to shards based on the values of their shard key attributes.
  *        The values of all shard key attributes in a document are hashed,
  *        and the hash value is used to determine the target shard.
  *        {@literal *}{@literal *}Note{@literal *}{@literal *}: Values of shard key attributes cannot be changed once set.
  ...
  *        to select from when creating a new collection. The selected {@literal *}shardingStrategy{@literal *} 
  ...
  *        
  *        If no sharding strategy is specified, the default will be {@literal *}hash{@literal *} for
  *        all collections, and {@literal *}enterprise-hash-smart-edge{@literal *} for all smart edge
  *        collections (requires the {@literal *}Enterprise Edition{@literal *} of ArangoDB). 
  *        Manually overriding the sharding strategy does not yet provide a 
  *        benefit, but it may later in case other sharding strategies are added.
  * @param smartJoinAttribute In an {@literal *}Enterprise Edition{@literal *} cluster, this attribute determines an attribute
  ...
  *        
  *        This feature can only be used in the {@literal *}Enterprise Edition{@literal *} and requires the
  *        {@literal *}distributeShardsLike{@literal *} attribute of the collection to be set to the name
  *        of another collection. It also requires the {@literal *}shardKeys{@literal *} attribute of the
  ...
  *        collection, the value stored in the {@literal *}smartJoinAttribute{@literal *} must be a string.
  * @param type (The default is {@literal *}2{@literal *}): the type of the collection to create.
  *        The following values for {@literal *}type{@literal *} are valid:
  *        
  *        - {@literal *}2{@literal *}: document collection
  *        - {@literal *}3{@literal *}: edge collection
  * @param waitForSync If {@literal *}true{@literal *} then the data is synchronized to disk before returning from a
