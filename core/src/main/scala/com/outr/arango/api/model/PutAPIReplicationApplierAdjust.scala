...
/**
  ...
  * @param adaptivePolling if set to {@literal *}true{@literal *}, the replication applier will fall
  ...
  *        
  *        Setting {@literal *}adaptivePolling{@literal *} to false will make the replication applier
  ...
  *        automatic resynchronization is enabled and kicks in. Setting this to {@literal *}0{@literal *}
  *        will
  ...
  *        based on the setting of {@literal *}restrictType{@literal *}
  * @param restrictType the configuration for {@literal *}restrictCollections{@literal *}; Has to be either {@literal *}include{@literal *} or {@literal *}exclude{@literal *}
