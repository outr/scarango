...
/**
  ...
  *        automatic resynchronization is enabled and kicks in. Setting this to {@literal *}0{@literal *} will
  *        effectively disable {@literal *}autoResync{@literal *}. Setting it to some other value will limit
  ...
  *        {@literal *}adaptivePolling{@literal *} is set to {@literal *}true{@literal *}.
  *        This value will be ignored if set to {@literal *}0{@literal *}.
  ...
  *        for continuous replication when {@literal *}autoResync{@literal *} is set to {@literal *}true{@literal *} because this
  ...
  * @param requireFromPresent if set to {@literal *}true{@literal *}, then the replication applier will check
  ...
  *        {@literal *}requireFromPresent{@literal *} is {@literal *}true{@literal *}, the replication applier will abort with an
  *        appropriate error message. If set to {@literal *}false{@literal *}, then the replication applier will
  *        still start, and ignore the data loss.
  * @param restrictCollections an optional array of collections for use with {@literal *}restrictType{@literal *}.
  *        If {@literal *}restrictType{@literal *} is {@literal *}include{@literal *}, only the specified collections
  ...
  * @param verbose if set to {@literal *}true{@literal *}, then a log line will be emitted for all operations
