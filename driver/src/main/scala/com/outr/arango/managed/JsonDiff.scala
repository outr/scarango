...
object JsonDiff {
  ...
  private def append(v1: Json, v2: Json): Json =
    ...
    else if (v1.isArray && v2.isArray) Json.fromValues(v1.asArray.get.toList ::: v2.asArray.get.toList)
  ...
  def diff(v1: Json, v2: Json): Diff =
    ...
    else if (v1.isArray && v2.isArray) diffJsonArray(v1.asArray.get.toList, v2.asArray.get.toList)
